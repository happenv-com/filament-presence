...
return RectorConfig::configure()
    ...
    ->withPhpSets()
    ->withSkip([
        // Laravel 12+ only (the abstract is inferred from the closure's return
        // type); composer.json still allows Laravel 11, which CI cannot install.
        ContainerBindConcreteWithClosureOnlyRector::class,
        // public API: apps call PresenceChannel::authorize($user, $roomKey)
        // from their own channel definitions (see the README).
